...
# This is a module variable thus its state persists between REST API calls.
# In a real application, the PEOPLE data would be in a database, file or network resource.
# Some thing that persists beyond the running/stopping of the web app.
